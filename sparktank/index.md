...
sections:
  ...
  splitColumns:
    ...
    - header: Spark Tank Timeline
      descriptor: >
        <h4>October - 15 November, 2022</h4><br> 
        <h5>Window for Spark Tank submissions</h5>
        <br>
        <h4>15 November - 7 December, 2022</h4><br>
        ...
        <br>
        <h4>15 December, 2022</h4><br>
        <h5>Pitch your idea to the Spark Tank judges panel</h5>
        <br>
        <br>
        <h4>16 December, 2022 - 15 January, 2023</h4><br>
